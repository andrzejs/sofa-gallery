$(document).ready(function() {
  ...
  $('select#news_event_news_type').change(function() {
    if ($(this).val() != 'news')
      $('.date_fields').show();
    else
      $('.date_fields').hide();
  })
  $('ul.sortable_resources').each(function(){
    $(this).sortable({  handle: 'div.icon',
      update: function() {
...
$.VSVSVS = function(){
  ...
  $(document).ready(function(){
    if($('#file_container').get(0))  $.VSVSVS.enable_photo_uploader();
  });
